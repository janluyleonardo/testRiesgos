                    ...
                    <div class="container mt-5">
                        <div class="row">
                            ...
                            <div class="col-md-12 mx-auto mt-2">
                                ...
                                <input class="form-control form-control-sm" type="text" name="pregunta"value="{{ old('pregunta')}}" placeholder="Ingrese la pregunta"id="pregunta" required>
                                @error('pregunta')
                            ...
                            <div class="col-md-6 mx-auto mt-2">
                                ...
                                <input class="form-control form-control-sm" type="text" name="respuestaUno"value="{{ old('respuestaUno') }}" placeholder="Ingrese la respuesta"id="respuestaUno" required>
                                @error('respuestaUno')
                                    <div class="text-danger">el campo es requerido</div>
                                @enderror
                            ...
                            <div class="col-md-6 mx-auto mt-2">
                                ...
                                <input class="form-control form-control-sm" type="text" name="respuestaDos"value="{{ old('respuestaDos') }}" placeholder="Ingrese la respuesta" id="respuestaDos"required>
                                @error('respuestaDos')
                                    <div class="text-danger">el campo es requerido</div>
                                @enderror
                            ...
                            <div class="col-md-6 mx-auto mt-2">
                                ...
                                <input class="form-control form-control-sm" type="text" name="respuestaTres"value="{{ old('respuestaTres') }}" placeholder="Ingrese la respuesta"id="respuestaTres" required>
                                @error('respuestaTres')
                                    <div class="text-danger">el campo es requerido</div>
                                @enderror
                            ...
                            <div class="col-md-6 mx-auto mt-2">
                                ...
                                <input class="form-control form-control-sm" type="text" name="respuestaCuatro"value="{{ old('respuestaCuatro') }}" placeholder="Ingrese la respuesta"id="respuestaCuatro" required>
